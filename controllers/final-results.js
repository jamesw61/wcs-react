...
// this function takes in a list of each of the dancers scores and returns an object 
// with the following data type { judges: [], leaders: [], followers: []}  Leaders and followers 
// with the same index are paired together
